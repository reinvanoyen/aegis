<?php $this->renderHead( $this->page->basetpl); ?><?php $this->setBlock( 'title', function() { ?>Welcome to my webpage<?php } ) ?><?php $this->setBlock( 'body', function() { ?>
	...
	<?php } ) ?><?php $this->renderBody( $this->page->basetpl); ?>